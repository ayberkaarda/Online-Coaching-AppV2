...
10. **(SIRADAKI İŞ)** Faz 2 (koç-danışan çekirdek akışı) — güvenlik temeli
    sağlamlaştırıldıktan **ve** kimlik sistemi kurulduktan **ve** borç temizliği
    tamamlandıktan sonra. Faz 2'nin ilk mekanik işi emoji → Lucide dönüşümüdür ve E2E
    locator güncellemeleriyle aynı PR'da yapılır (ADR-0016); `LoopRing` ilk göründüğü
    ekranla (gym modu dinlenme sayacı) birlikte yazılır (ADR-0017); Katman B restilizasyonu
    (ADR-0018) ve katalog için sunucu taraflı arama + sayfalama da bu fazın işi.
